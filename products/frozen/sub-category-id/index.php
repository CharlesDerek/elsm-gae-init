<?php include $_SERVER['DOCUMENT_ROOT']."/includes/header.php"; ?>
  ...
  <div id="coverSection" class="coversectioncategory1">
    ...
    <div class="headingcountwrapper">
      <h4 class="itemcountheader">Please Choose from the following {sub_Category_Count} selections of { SecondaryCategory_Name}.</h4>
    </div>
    <div class="dynamicgrid" data-ix="cardfloat">
      <div class="tag-wrapperflex">
        <div class="card card4-content">
          <div class="tagline tagline-promo-40"><strong>{Sub_category_title}</strong></div>
          <h3 class="card-headlinefst">{Sub_category_Item_name}</h3>
          <h3 class="card-headline2nd dark-card-headline _6col-card"><em>{(Item_ounces} oz.)</em></h3><a href="../../../products/frozen/sub-category-id/item-id/index.php" class="button default-button card-cta w-button" data-ix="cardanimate">View Item</a></div>
      </div>
      <div class="tag-wrapperflex">
        <div class="card card4-content">
          <div class="tagline tagline-promo-40"><strong>{Sub_category_title}</strong></div>
